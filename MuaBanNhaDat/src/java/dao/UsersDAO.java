...
public class UsersDAO {
    ...
    public static boolean kichhoat_taikhoan(long id) throws SQLException
    {
        ...
        PreparedStatement ps = con.prepareStatement("update users set user_kichhoat = 1 where stt='"+id+"'");
    ...
    {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("select*from users where user_Email='"+email+"'");
    ...
    public boolean suaEmail(String email, Long stt) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("update users set user_Email='" + email + "' where  stt='" + stt + "' ");
        return ps.executeUpdate() == 1;
    }
    ...
    public boolean suaUserPass(String pass, Long stt) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("update users set user_Pass='" + pass + "' where  stt='" + stt + "' ");
        return ps.executeUpdate() == 1;
    }
    ...
    public boolean suaUserName(String username, Long stt) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("update users set user_Name='" + username + "' where  stt='" + stt + "' ");
        return ps.executeUpdate() == 1;
    }
    ...
    public boolean suaTen(String ten, Long stt) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("update users set hovaten='" + ten + "' where  stt='" + stt + "' ");
        return ps.executeUpdate() == 1;
    }
    ...
    public boolean xoaTK(Long stt) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("delete from users where stt='" + stt + "' ");
        return ps.executeUpdate() == 1;
    }
    ...
    public boolean themTK(Users u) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("insert into users(hovaten,user_Name,user_Pass,user_Email,user_diachi,user_sdt,user_role,user_kichhoat,user_code) values(?,?,?,?,?,?,?,?,?)");
    ...
    public static Users login(String username, String password) throws SQLException {
        ...
        try 
        {
            ps = conn.prepareStatement("select*from users where user_Name='"+username+"' and user_Pass='"+password+"'");
            rs = ps.executeQuery();
    ...
    public boolean kiemtra(String username) throws SQLException {
        Connection con = DBConnect.getConnection();
        PreparedStatement ps = con.prepareStatement("select * from users where user_Name='" + username + "' ");
        ResultSet rs = ps.executeQuery();
        while (rs.next()) {
            return true;
        }
