                    ...
                    if (usersDAO.kiemtra(request.getParameter("username"))
                        ...
                        users.setUser_code(uuid);
                        {
                            try {
                                ...
                                SendMail.sendMail(request.getParameter("email"), "Hoan Tât Quá Trinh Đăng Ky",
                                        "Chào Ban," + users.getHovaten() + "\n"
                                        + "Cám on ban đa đăng ky tài khoan tại web site bat đong san CÁI BANG.Vui long kích hoat xác nhan tài khoan bên dươi :\n"
                                        + "Ban có thê copy link và dán vào trinh duyêt : \n"
                                        + kichhoat + "\n " + "Trân Trong,\n "
                                        + "Team chăm sóc KH,Team DTU\n" + "Nêu ban có thăc măc ,ban vui long send email to Leanhhieu2210@gmail.com");
